...
SELECT  now(), 0 as Version, StartDate, LocalityID + 2011, 3 as DisciplineID FROM tempColEvent; -- change

-- change to remove number shifting and make more general --
INSERT INTO collector (TimestampCreated, Version, IsPrimary, DivisionID, CollectingEventID, AgentID)
SELECT now(), 0 as Version, IsPrimary, 2 as DivisionID, CollectingEventID + 2017, AgentID FROM tempCollector; -- change
...
SELECT now(), 0 as Version, 4 as CollectionMemberID, CollectionEventID + 2017, 4 as CollectionID, CatalogNumber, AltCatalogNumber, occid FROM tempColObject; -- change
