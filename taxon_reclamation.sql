...
DECLARE cur CURSOR FOR SELECT SciName, rankID, MAX(parenttid) as parentID, taxaenumtree.tid FROM taxaenumtree, taxa WHERE taxa.tid = taxaenumtree.tid AND rankID = 10 GROUP BY taxaenumtree.tid; 
